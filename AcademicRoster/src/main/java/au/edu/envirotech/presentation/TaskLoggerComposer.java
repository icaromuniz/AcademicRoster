...
public class TaskLoggerComposer extends BindComposer<Component> {
...
//					null, null, null, null, null, null);
	...
	private boolean isUserAuthorized() {
		...
		return true;
//		return false; // FIXME put back after testing
	}
	...
	public List<String> getDepartmentList(){
		String[] departmentList = {"Management", "Human Resources", "Academic"};
		return Arrays.asList(departmentList);
	}
